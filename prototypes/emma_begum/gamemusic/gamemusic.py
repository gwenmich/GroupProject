def mini_game(building):
    ...
    if building == "library":
        ...
        pygame.mixer.music.load('music/lofi2.mp3') # Stand in
        ...
        pygame.mixer.music.load('music_assets/chill.mp3') # Stand in
        pygame.mixer.music.play(-1)
        pass
    elif building == "classroom":
        # call classroom game function
        pygame.mixer.music.load('music_assets/lofi3.mp3') # Stand in
        pygame.mixer.music.play(-1)
        pass
    elif building == "it_dept":
        # call it game function
        pygame.mixer.music.load('music_assets/lofi4.mp3') # Stand in
        pygame.mixer.music.play(-1)
        pass