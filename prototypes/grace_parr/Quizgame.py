...
BACKGROUND_PATH = r"C:\Users\Lenap\PycharmProjects\CFGDegree-GroupProjectTeam1\prototypes\grace_parr\Library.png"
...
try:
    ...
    LARGE_FONT = pygame.font.Font(FONT_PATH, 20)
...
class Question:
    ...
    def draw(self, screen):
        y_offset = 150
        lines = wrap_text(self.question_text, LARGE_FONT, WIDTH - 100)
        for line in lines:
            question_surface = LARGE_FONT.render(line, True, WHITE)
...
class QuizGame:
    def __init__(self):
        self.questions = [
            ...
            Question("Which data structure is FILO?",
                     ["A. List", "B. Queue", "C. Stack", "D. Set"], 2),
    ...
    def draw(self, screen):
        ...
        if self.current_question < len(self.questions):
            ...
            if self.selected_choice is not None:
                y_offset = 150 + 40 * (self.selected_choice + 1)
    ...
    def draw_end_screen(self, screen):
        ...
        end_message = "Well done, you passed!" if self.score >= 3 else "Good try, but try again!"
...
def draw_librarian_intro():
    ...
    lines = wrap_text(intro_text, SMALL_FONT, WIDTH - 40)
