...
class Config:
    ...
    def fonts():
        return {
            "default": pygame.font.Font("PressStart2P.ttf", 18),
            "title": pygame.font.Font("PressStart2P.ttf", 32)
        }
...
obstacle = pygame.image.load("stop.png")
...
class MazeGame:
    ...
    def show_title_screen(self):
        ...
        #title text
        title_text = Config.fonts()["title"].render("Maze Game", True, Config.colours()["text"])
        #instructions text
    ...
    def win_screen(self): #displays a screen saying they won if they made it through all levels
        self.draw_background()
        win_text = Config.fonts()["title"].render("You Win! Game Complete!", True, Config.colours()["text"])
